...
cd \Users\Kadir\PycharmProjects\pythonProject
...
# Görev 1 Çözüm
###############################################
[col.upper() if df[col].dtype == "O" else "NUM_" + col.upper() for col in df.columns]
