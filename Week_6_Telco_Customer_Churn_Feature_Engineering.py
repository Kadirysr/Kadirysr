...
# %50.4 erkek %49.5 kadın
# %48.3 ün partneri var
# %30 una yakının bakmakla yükümlü olduğu kişi var.
# %90 nın telefon servisi var.
# %42 sinin birden fazla telefon servisi var.
# şeklinde tüm veriler kontrl edilir.
...
# kadın %49 erkek %50.4 churn
# partneri olanlar %48 . daha düşük.
# dependents i olanlar %29. churn oranı daha düşük.
# phone service i olmayanların oranı %9. churn oranı daha düşük.
# aylık müşterilerin oranı daha yüksek. %55.
# yaşlı olanların churn oranı daha düşük.
# ....
...
# TotalChargers - monthly charges ve totalchargers - tenure yüksek korelasyonlu olduğu görülmekte
...
# standartlaştırma yapıyoruz. Standartlaştırma her zaman tercih edilmeli. Optimizasyonda hata veya sapmaları engellemiş oluyor.
